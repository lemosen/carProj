...
@Component({
    ...
    templateUrl: './share-gift.page.html',
    styleUrls: ['./share-gift.page.scss'],
})
export class ShareGiftPage implements OnInit {

    list;

    name = 'Adonis';

    constructor(public navCtrl: NavController, public modalCtrl: ModalController, public wechatProvider: WechatService, public appConfig: AppConfig) {
    }
    ...
    async goReceiveGift() {
        ...
        // this.navCtrl.navigateForward("ReceiveGiftPage")
    }

    giftAgain() {
        this.navCtrl.navigateBack("AreaGiftPage")
    }
