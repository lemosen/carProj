...
let chats = [
    new SideChat(
        ...
        'Ashley Ahlberg',
        'Online',
        'Hi, I\'m looking for admin template with bootstrap 4.  What do you think about Yi-admin-app Admin Template?',
...
let talks = [
    new SideChat(
        ...
        'Emilio Verdines',
        'Online',
        'Hi, Yi-admin-app is a fully responsive, organized folder structure, clean & customizable code, easy to use and much more...',
...
//             authorStatus: 'Online',
//             text: 'Hi, I\'m looking for admin template with bootstrap 4.  What do you think about Yi-admin-app Admin Template?',
