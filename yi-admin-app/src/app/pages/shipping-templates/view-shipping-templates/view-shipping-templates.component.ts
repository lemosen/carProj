...
@Component({
    selector: 'app-view-shipping-templates',
    templateUrl: './view-shipping-templates.component.html',
    styleUrls: ['./view-shipping-templates.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ViewShippingTemplatesComponent implements OnInit {
