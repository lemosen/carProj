...
@Component({
    selector: 'app-edit-shipping-templates',
    templateUrl: './edit-shipping-templates.component.html',
    styleUrls: ['./edit-shipping-templates.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class EditShippingTemplatesComponent implements OnInit {
