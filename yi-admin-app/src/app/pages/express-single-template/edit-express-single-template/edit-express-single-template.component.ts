...
@Component({
    selector: 'app-edit-express-single-template',
    templateUrl: './edit-express-single-template.component.html',
    styleUrls: ['./edit-express-single-template.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class EditExpressSingleTemplateComponent implements OnInit {
