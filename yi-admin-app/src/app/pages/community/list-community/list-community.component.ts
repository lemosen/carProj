...
export class ListCommunityComponent extends CommonList implements OnInit {
    ...
    disable(recommendId){
        ...
        this.dialogService.confirm('提示', '确认禁用吗？').then(result => {
            if (result) {
                this.communityService.banKai(recommendId).subscribe(response => {
    ...
    enable(communityId){
        this.dialogService.confirm('提示', '确认启用吗？').then(result => {
            if (result) {
                this.communityService.banKai(communityId).subscribe(response => {
                    if (response.result == SUCCESS) {
                        this.dialogService.toast();
                        this.getDatas();
                    } else {
