...
@Component({
    ...
    templateUrl: './add-essential-information.component.html',
    styleUrls: ['./add-essential-information.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AddEssentialInformationComponent implements OnInit {
