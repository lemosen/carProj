...
@Component({
    ...
    templateUrl: './edit-essential-information.component.html',
    styleUrls: ['./edit-essential-information.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class EditEssentialInformationComponent implements OnInit {
