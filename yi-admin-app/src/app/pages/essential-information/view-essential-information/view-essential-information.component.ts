...
@Component({
    ...
    templateUrl: './view-essential-information.component.html',
    styleUrls: ['./view-essential-information.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ViewEssentialInformationComponent implements OnInit {
