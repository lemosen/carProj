...
export class ViewReturnOrderComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder, private route: ActivatedRoute, private location: Location, public userService: UserService, private router: Router,
                private returnOrderService: ReturnOrderService, private dialogService: DialogsService) {
        this.buildForm();
    }
    addresss:string[]=[];
    ngOnInit() {
       ...
       /* alert(this.returnOrder.consigneeAddr)
        alert(this.returnOrder.consigneeAddr.substring(0,6))*/
    ...
    getById(objId) {
        this.returnOrderService.getById(objId).subscribe(response => {
            if (response.result == SUCCESS) {
                ...
                this.addresss[0]=this.transform(this.returnOrder.consigneeAddr.substring(0,6));
                this.addresss[1]=this.transform(this.returnOrder.consigneeAddr.substring(6,12));
                this.addresss[2]=this.transform(this.returnOrder.consigneeAddr.substring(12,18));
                this.addresss[3]=this.transform(this.returnOrder.consigneeAddr.substring(18,30));
            } else {
        ...
        this.commonForm.setValue({
            ...
            returnProcesse: {
              /*  returnOrderId:
                ...
                ,*/
                user: {
                    id: returnOrder.returnProcesse.user.id,
                    fullName: returnOrder.returnProcesse.user.fullName
                }
                ,
               remark:
                returnOrder.returnProcesse.remark
                ,
            },
        });
    ...
    refusalToConfirm(id, state) {
        ...
        if (this.commonForm.value.returnProcesse.user.fullName == "请选择") {
            ...
            if (result) {
                ...
                this.returnOrderService.returnGoods(searchObj).subscribe(response => {
                    if (response.result == SUCCESS) {
                        ...
                        this.router.navigate(['/pages/return-order/list']);
                    } else {
                        this.dialogService.alert('请求失败', response.message);
                    }
