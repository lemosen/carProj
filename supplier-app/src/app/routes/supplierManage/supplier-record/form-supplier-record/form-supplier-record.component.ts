...
@Component({
  ...
  templateUrl: './form-supplier-record.component.html',
  styleUrls: ['./form-supplier-record.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class FormSupplierRecordComponent implements OnInit, OnChanges {
