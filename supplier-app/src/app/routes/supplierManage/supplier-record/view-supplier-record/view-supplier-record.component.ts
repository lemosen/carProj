...
@Component({
  ...
  templateUrl: './view-supplier-record.component.html',
  styleUrls: ['./view-supplier-record.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ViewSupplierRecordComponent implements OnInit {
