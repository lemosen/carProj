...
import com.yi.core.gift.domain.simple.GiftOrderSimple;
 ...
 */
@Deprecated
public class GiftOrderItemListVo extends ListVoDomain implements java.io.Serializable {
	 ...
	 */
	@NotNull
	private GiftOrderSimple giftOrder;
	/**
	 * 会员（member表ID）
	 */
	@NotNull
	...
	public GiftOrderSimple getGiftOrder() {
		return giftOrder;
	}

	public void setGiftOrder(GiftOrderSimple giftOrder) {
