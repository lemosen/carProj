 ...
 *
 */
public class GiftBagVo extends VoDomain implements java.io.Serializable {
	...
	public Set<GiftSimple> getGifts() {
		return gifts;
	}

	public void setGifts(Set<GiftSimple> gifts) {
		this.gifts = gifts;
	}
