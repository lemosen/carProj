 ...
 * @since 1.0
 */
public class FreightTemplateConfigVo extends VoDomain implements java.io.Serializable {
	 ...
	 * 自定义运费
	 */
	private List<CustomFreightTemplateSimple> customFreightTemplates = new ArrayList<>(0);

	/**
	 * 指定条件包邮
	 */
	private List<FreeFreightTemplateSimple> freeFreightTemplates = new ArrayList<>(0);
	...
	public List<CustomFreightTemplateSimple> getCustomFreightTemplates() {
		return customFreightTemplates;
	}

	public void setCustomFreightTemplates(List<CustomFreightTemplateSimple> customFreightTemplates) {
		this.customFreightTemplates = customFreightTemplates;
	}

	public List<FreeFreightTemplateSimple> getFreeFreightTemplates() {
		return freeFreightTemplates;
	}

	public void setFreeFreightTemplates(List<FreeFreightTemplateSimple> freeFreightTemplates) {
