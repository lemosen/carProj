 ...
 */
@Deprecated
public class RebateGroupBo extends BoDomain implements java.io.Serializable {
	...
	private Set<RebateSetBo> rebateSets;
	...
	public Set<RebateSetBo> getRebateSets() {
		return rebateSets;
	}

	public void setRebateSets(Set<RebateSetBo> rebateSets) {
