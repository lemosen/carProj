 ...
 */
@Deprecated
public class CommunityGroupSimple extends SimpleDomain implements java.io.Serializable {
     ...
     * 小区（community表ID）
     */
    private CommoditySimple community;
    /**
     * 活动库存
     */
    @NotNull
    ...
    public CommoditySimple getCommunity() {
        return community;
    }

    public void setCommunity(CommoditySimple community) {
