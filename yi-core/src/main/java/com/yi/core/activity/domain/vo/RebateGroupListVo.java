...
import com.yi.core.activity.domain.simple.RebateSetSimple;
 ...
 */
@Deprecated
public class RebateGroupListVo extends ListVoDomain implements java.io.Serializable {
    ...
    private Set<RebateSetSimple> rebateSets;
    ...
    public Set<RebateSetSimple> getRebateSets() {
        return rebateSets;
    }

    public void setRebateSets(Set<RebateSetSimple> rebateSets) {
