 ...
 */
@Deprecated
public class NationalGroupMemberBo extends BoDomain implements java.io.Serializable {
	 ...
	 */
	@NotNull
	private NationalGroupRecordBo nationalGroupRecord;
	/**
	 * 成员（member表ID）
	 */
	@NotNull
	...
	public NationalGroupRecordBo getNationalGroupRecord() {
		return nationalGroupRecord;
	}

	public void setNationalGroupRecord(NationalGroupRecordBo nationalGroupRecord) {
