 ...
 *
 */
public class AreaListVo extends ListVoDomain implements java.io.Serializable {
	...
	public List<AreaListVo> getChildren() {
		return children;
	}

	public void setChildren(List<AreaListVo> children) {
