...
@Component({
  ...
  templateUrl: './edit-supplier-record.component.html',
  styleUrls: ['./edit-supplier-record.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EditSupplierRecordComponent implements OnInit {
        ...
        if (formValue) {
            ...
            this.supplierWithdrawService.update(formValue.obj).subscribe(response => {
                if (response.result == SUCCESS) {
                    ...
                    this.router.navigate(['/dashboard/supplierWithdraw/list']);
                } else {
                    this.msgSrv.error('请求失败'+response.message);
                }
