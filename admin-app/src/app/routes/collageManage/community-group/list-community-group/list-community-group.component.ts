...
@Component({
  selector: 'list-community-group',
  templateUrl: './list-community-group.component.html',
  styleUrls: ['./list-community-group.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ListCommunityGroupComponent implements OnInit {
  ...
  constructor(public route: ActivatedRoute, public router: Router, private communityGroupService: CommunityGroupService, public msg: NzMessageService,
  ...
  getData() {
    this.loading = true;
    this.communityGroupService.query(this.pageQuery).subscribe(response => {
  ...
  remove(communityGroupId) {
    this.communityGroupService.removeById(communityGroupId).subscribe(response => {
