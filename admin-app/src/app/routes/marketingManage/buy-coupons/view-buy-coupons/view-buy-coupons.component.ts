...
@Component({
  ...
  templateUrl: './view-buy-coupons.component.html',
  styleUrls: ['./view-buy-coupons.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ViewBuyCouponsComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.params.subscribe((params: ParamMap) => {
      ...
      this.pageQuery.addOnlyFilter("coupon.id",this.couponId,"eq");
    });
    this.getData();
  }
