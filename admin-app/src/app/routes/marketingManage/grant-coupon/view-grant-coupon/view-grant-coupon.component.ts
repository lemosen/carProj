...
@Component({
  selector: 'view-grant-coupon',
  templateUrl: './view-grant-coupon.component.html',
  styleUrls: ['./view-grant-coupon.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ViewGrantCouponComponent implements OnInit {
