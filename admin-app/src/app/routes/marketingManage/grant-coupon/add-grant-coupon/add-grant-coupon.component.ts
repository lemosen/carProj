...
@Component({
    selector: 'add-grant-coupon',
    templateUrl: './add-grant-coupon.component.html',
    styleUrls: ['./add-grant-coupon.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AddGrantCouponComponent implements OnInit {
