...
@Component({
  selector: 'edit-grant-coupon',
  templateUrl: './edit-grant-coupon.component.html',
  styleUrls: ['./edit-grant-coupon.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EditGrantCouponComponent implements OnInit {
