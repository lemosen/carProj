...
@NgModule({
  ...
  providers: [NzModalService, CategoryService, RescService, CommentService, DistrictPipe, ArticleCommentService, SaleOrderService, ExpressService, AreaService,OperateCategoryService,RegionService,RegionGroupService,AttachmentService,MemberService],
