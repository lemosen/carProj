...
import {SupplierVo} from "./supplier-vo.model";
import {SaleOrderVo} from "./sale-order-vo.model";
import {AfterSaleProcessVo} from "./after-sale-process-vo.model";
import {AttachmentVo} from "./attachment-vo.model";

export class AfterSaleOrderVo {
  /**
   * 售后单ID
   */
  id: number;
  ...
  afterSaleProcess: AfterSaleProcessVo;

  attachmentVos: AttachmentVo[];
}
