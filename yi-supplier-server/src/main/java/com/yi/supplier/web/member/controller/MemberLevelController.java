...
package com.yi.supplier.web.member.controller;
...
public class MemberLevelController {
	...
	public RestResult addMemberLevel(@RequestBody MemberLevel memberLevel) {
		try {
			...
			return RestUtils.error("add MemberLevel failure : " + ex.getMessage());
		}
	}
	...
	public RestResult updateMemberLevel(@RequestBody MemberLevel memberLevel) {
		try {
			...
			return RestUtils.error("update MemberLevel failure : " + ex.getMessage());
		}
	}
