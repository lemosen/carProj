...
public class RecommendController {
	...
	public RestResult addRecommend(@RequestBody Recommend recommend) {
		try {
			Recommend dbRecommend = recommendService.addRecommend(recommend);
	...
	public RestResult updateRecommend(@RequestBody Recommend recommend) {
		try {
			Recommend dbRecommend = recommendService.updateRecommend(recommend);
			return RestUtils.successWhenNotNull(dbRecommend);
		} catch (BusinessException ex) {
