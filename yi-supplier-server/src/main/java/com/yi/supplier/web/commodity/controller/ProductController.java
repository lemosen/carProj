...
public class ProductController {
	...
	public RestResult viewProduct(@RequestParam("id") int productId) {
		try {
			...
			return RestUtils.error("get Product failure : " + ex.getMessage());
		}
	}
	...
	public RestResult addProduct(@RequestBody Product product) {
		try {
			...
			return RestUtils.error("add Product failure : " + ex.getMessage());
		}
	}
	...
	public RestResult updateProduct(@RequestBody Product product) {
		try {
			...
			return RestUtils.error("update Product failure : " + ex.getMessage());
		}
	}
	...
	public RestResult removeProductById(@RequestParam("id") int productId) {
		try {
			...
			return RestUtils.error("remove Product failure : " + ex.getMessage());
		}
	}
}