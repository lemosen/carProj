...
public class AttachmentController {
	...
	public Page<AttachmentVo> query(@RequestBody Pagination<Attachment> query, HttpServletRequest request) {
		...
		try {
			...
			for (MultipartFile uploadFile : uploadFiles) {
				...
				try {
					...
					vo.setUrl(attachmentStorageExecutor.genFileUrl("/attachment/show/", attachment.getFsGuid(),
							null));
