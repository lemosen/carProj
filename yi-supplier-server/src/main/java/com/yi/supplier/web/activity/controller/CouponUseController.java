...
public class CouponUseController {
	...
	public RestResult addCouponUse(@RequestBody CouponUse couponUse) {
		try {
			CouponUse dbCouponUse = couponUseService.addCouponUse(couponUse);
	...
	public RestResult updateCouponUse(@RequestBody CouponUse couponUse) {
		try {
			CouponUse dbCouponUse = couponUseService.updateCouponUse(couponUse);
			return RestUtils.successWhenNotNull(dbCouponUse);
		} catch (BusinessException ex) {
